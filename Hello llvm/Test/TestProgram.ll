...
define dso_local i32 @main() #2 {
  ...
  %8 = call i32 @_Z7encryptPhPc(i8* %7, i8* getelementptr inbounds ([100 x i8], [100 x i8]* @input, i64 0, i64 0))
...
11:                                               ; preds = %0
  ...
  %13 = call i32 @memcmp(i8* %12, i8* getelementptr inbounds ([100 x i8], [100 x i8]* bitcast (<{ [23 x i8], [77 x i8] }>* @enc to [100 x i8]*), i64 0, i64 0), i64 22) #5
  %14 = icmp ne i32 %13, 0
  %15 = xor i1 %14, true
  br label %16
...
21:                                               ; preds = %16
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.2, i64 0, i64 0))
  br label %25
