...
namespace llvm{
    ...
    class Substitution : public FunctionPass {
        public:
            ...
            // ¼Ó·¨Ìæ»»£ºa = b + c -> r = rand (); a = b + r; a = a + c; a = a - r
            void addRand(BinaryOperator *BI);
            // ¼Ó·¨Ìæ»»£ºa = b + c -> r = rand (); a = b - r; a = a + b; a = a + r
            ...
            // ¼õ·¨Ìæ»»£ºa = b - c -> r = rand (); a = b + r; a = a - c; a = a - r
            void subRand(BinaryOperator *BI);
            // ¼õ·¨Ìæ»»£ºa = b - c -> a = b - r; a = a - c; a = a + r
...
// »ìÏý´ÎÊý£¬»ìÏý´ÎÊýÔ½¶à»ìÏý½á¹ûÔ½¸´ÔÓ
