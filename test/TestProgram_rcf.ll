...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  %.reload50.reg2mem = alloca i32, align 4
...
581:                                              ; preds = %907, %572
  ...
  store i32 %582, i32* %.reg2mem49, align 4
  %583 = add i32 %574, 1
  %584 = mul i32 %574, %583
  %585 = mul i32 %574, %574
  %586 = sub i32 %584, %585
...
641:                                              ; preds = %941, %632
  %.reload50 = load volatile i32, i32* %.reg2mem49, align 4
  store i32 %.reload50, i32* %.reload50.reg2mem, align 4
  %642 = add i32 %634, 1
  %643 = mul i32 %634, %642
  %644 = mul i32 %634, %634
  %645 = sub i32 %643, %644
...
648:                                              ; preds = %941, %641
  %.reload50.reload = load volatile i32, i32* %.reload50.reg2mem, align 4
  ret i32 %.reload50.reload
...
809:                                              ; preds = %385, %372
  %.reload430 = load volatile i32, i32* %.reg2mem42, align 4
  %810 = icmp ne i32 %.reload430, 4
...
855:                                              ; preds = %479, %466
  %.reload247 = load volatile i32*, i32** %.reg2mem, align 8
  store i32 0, i32* %.reload247, align 4
  %856 = mul i32 %468, 3
  %857 = sub i32 %468, 2
  %858 = mul i32 %856, %857
  %859 = mul i32 %468, %468
...
900:                                              ; preds = %564, %551
  %.reload148 = load volatile i32*, i32** %.reg2mem, align 8
  store i32 -1, i32* %.reload148, align 4
  %901 = add i32 %553, 1
  %902 = mul i32 %553, %901
  %903 = mul i32 %553, %553
  %904 = sub i32 %902, %903
...
907:                                              ; preds = %581, %572
  %.reload51 = load volatile i32*, i32** %.reg2mem, align 8
  %908 = load i32, i32* %.reload51, align 4
  store i32 %908, i32* %.reg2mem49, align 4
  %909 = sub i32 %574, 1
  %910 = add i32 %574, 3
  %911 = add i32 %574, 4
  %912 = sub i32 %574, 3
...
941:                                              ; preds = %641, %632
  %.reload5052 = load volatile i32, i32* %.reg2mem49, align 4
  store i32 %.reload5052, i32* %.reload50.reg2mem, align 4
  %942 = sub i32 %634, 1
  %943 = add i32 %634, 3
  %944 = add i32 %634, 4
  %945 = sub i32 %634, 3
